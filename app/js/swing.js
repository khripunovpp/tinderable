...
! function(t) {
  ...
  (function(t) {
    ...
    var r = n(1),
      ...
      s = n(6),
      u = i(s);
    t.gajus = t.gajus || {}, t.gajus.Swing = {
      Stack: o["default"],
      Card: u["default"]
    }, e.Stack = o["default"], e.Card = u["default"]
  }).call(e, function() {
    return this
  }())
}, function(t, e, n) {
  ...
  f = function(t) {
    var e = void 0,
      ...
      s = void 0;
    return e = function() {
      s = {}, r = new u["default"].SpringSystem, n = o["default"](), i = []
    }, e(), s.getConfig = function() {
      return t
      ...
      var e = void 0,
        r = void 0;
      return e = c["default"](s, t), r = ["throwout", "throwoutend", "throwoutleft", "throwoutright", "throwin", "throwinend", "dragstart", "dragmove", "dragend"], r.forEach(function(t) {
        e.on(t, function(e) {
          n.trigger(t, e)
        })
      }), i.push({
    ...
    ! function() {
      ...
      o.extend(a.prototype, {
        ...
        createSpring: function(t, e) {
          var n;
          return n = void 0 === t || void 0 === e ? l.DEFAULT_ORIGAMI_SPRING_CONFIG : l.fromOrigamiTensionAndFriction(t, e), this.createSpringWithConfig(n)
        },
        createSpringWithBouncinessAndSpeed: function(t, e) {
          var n;
          return n = void 0 === t || void 0 === e ? l.DEFAULT_ORIGAMI_SPRING_CONFIG : l.fromBouncinessAndSpeed(t, e), this.createSpringWithConfig(n)
        },
        ...
        deregisterSpring: function(t) {
          i(this._activeSprings, t), delete this._springRegistry[t.getId()]
        },
        ...
        loop: function(t) {
          ...
          for (i = 0; r > i; i++) e = this.listeners[i], e.onBeforeIntegrate && e.onBeforeIntegrate(this);
          for (this.advance(t, n), 0 === this._activeSprings.length && (this._isIdle = !0, this._lastTimeMillis = -1), i = 0; r > i; i++) e = this.listeners[i], e.onAfterIntegrate && e.onAfterIntegrate(this);
      ...
      var c = r.Spring = function _(t) {
        this._id = "s" + _._ID++, this._springSystem = t, this.listeners = [], this._currentState = new h, this._previousState = new h, this._tempState = new h
      };
      o.extend(c, {
        _ID: 0,
        ...
        advance: function(t, e) {
          ...
          if (!n || !this._wasAtRest) {
            var i = e;
            e > c.MAX_DELTA_TIME_SEC && (i = c.MAX_DELTA_TIME_SEC), this._timeAccumulator += i;
            for (var r, o, s, u, a, h, l, f, p, d, v = this._springConfig.tension, g = this._springConfig.friction, m = this._currentState.position, _ = this._currentState.velocity, y = this._tempState.position, T = this._tempState.velocity; this._timeAccumulator >= c.SOLVER_TIMESTEP_SEC;) this._timeAccumulator -= c.SOLVER_TIMESTEP_SEC, this._timeAccumulator < c.SOLVER_TIMESTEP_SEC && (this._previousState.position = m, this._previousState.velocity = _), r = _, o = v * (this._endValue - y) - g * _, y = m + r * c.SOLVER_TIMESTEP_SEC * .5, T = _ + o * c.SOLVER_TIMESTEP_SEC * .5, s = T, u = v * (this._endValue - y) - g * T, y = m + s * c.SOLVER_TIMESTEP_SEC * .5, T = _ + u * c.SOLVER_TIMESTEP_SEC * .5, a = T, h = v * (this._endValue - y) - g * T, y = m + a * c.SOLVER_TIMESTEP_SEC * .5, T = _ + h * c.SOLVER_TIMESTEP_SEC * .5, l = T, f = v * (this._endValue - y) - g * T, p = 1 / 6 * (r + 2 * (s + a) + l), d = 1 / 6 * (o + 2 * (u + h) + f), m += p * c.SOLVER_TIMESTEP_SEC, _ += d * c.SOLVER_TIMESTEP_SEC;
            this._tempState.position = y, this._tempState.velocity = T, this._currentState.position = m, this._currentState.velocity = _, this._timeAccumulator > 0 && this._interpolate(this._timeAccumulator / c.SOLVER_TIMESTEP_SEC), (this.isAtRest() || this._overshootClampingEnabled && this.isOvershooting()) && (this._springConfig.tension > 0 ? (this._startValue = this._endValue, this._currentState.position = this._endValue) : (this._endValue = this._currentState.position, this._startValue = this._endValue), this.setVelocity(0), n = !0);
            var S = !1;
            this._wasAtRest && (this._wasAtRest = !1, S = !0);
            var E = !1;
            n && (this._wasAtRest = !0, E = !0), this.notifyPositionUpdated(S, E)
          }
        },
        ...
        removeListener: function(t) {
          return i(this.listeners, t), this
        },
        removeAllListeners: function() {
      ...
      var p = r.OrigamiValueConverter = {
        ...
        d = r.BouncyConversion = function(t, e) {
          ...
          this.bouncyTension = this.projectNormal(i, .5, 200), this.bouncyFriction = this.quadraticOutInterpolation(n, this.b3Nobounce(this.bouncyTension), .01)
        };
      ...
      }), l.DEFAULT_ORIGAMI_SPRING_CONFIG = l.fromOrigamiTensionAndFriction(40, 7), o.extend(l.prototype, {
        friction: 0,
        tension: 0
      });
      var v = {};
      ...
      var g = r.MathUtil = {
        ...
        interpolateColor: function(t, e, n, i, r, s) {
          i = void 0 === i ? 0 : i, r = void 0 === r ? 1 : r, e = o.hexToRGB(e), n = o.hexToRGB(n);
      ...
      }), m || "undefined" == typeof t || "node" !== t.title || (m = n), o.onFrame = function(t) {
        return m(t)
      }, o.extend(e, r)
    }()
  ...
  function n() {
    c = !1, s.length ? a = s.concat(a) : h = -1, a.length && i()
  }
  ...
  u.nextTick = function(t) {
    ...
    a.push(new r(t, e)), 1 !== a.length || c || setTimeout(i, 0)
  ...
  (function(i) {
    ...
    m = function(t, e) {
      var n = void 0,
        ...
        A = void 0;
      return o = function() {
        n = {}, r = m.makeConfig(t.getConfig()), f = s["default"](), w = t.getSpringSystem(), I = w.createSpring(250, 10), x = w.createSpring(500, 20), v = {}, _ = {
          x: 0,
          y: 0
        }, I.setRestSpeedThreshold(.05), I.setRestDisplacementThreshold(.05), x.setRestSpeedThreshold(.05), x.setRestDisplacementThreshold(.05), b = r.throwOutDistance(r.minThrowOutDistance, r.maxThrowOutDistance), S = new a["default"].Manager(e, {
          recognizers: [
            [a["default"].Pan, {
              threshold: 2
            }]
          ]
        }), m.insertBelow(e), f.on("panstart", function() {
          m.appendToParent(e), f.trigger("dragstart", {
              target: e
            }), u = 0, c = 0, p = !0,
            function t() {
              p && (l(), g["default"](t))
          ...
          u = t.deltaX, c = t.deltaY
        }), f.on("panend", function(t) {
          var i = void 0,
            o = void 0;
          p = !1, i = _.x + t.deltaX, o = _.y + t.deltaY, r.isThrowOut(i, e, r.throwOutConfidence(i, e)) ? n.throwOut(i, o) : n.throwIn(i, o), f.trigger("dragend", {
            target: e
          })
          ...
          onSpringUpdate: function(t) {
            var e = void 0,
              n = void 0,
              i = void 0;
            e = t.getCurrentValue(), n = h["default"].MathUtil.mapValueInRange(e, 0, 1, v.fromX, 0), i = h["default"].MathUtil.mapValueInRange(e, 0, 1, v.fromY, 0), E(n, i)
          },
          ...
          onSpringUpdate: function(t) {
            var e = void 0,
              n = void 0,
              i = void 0;
            e = t.getCurrentValue(), n = h["default"].MathUtil.mapValueInRange(e, 0, 1, v.fromX, b * v.direction), i = v.fromY, E(n, i)
          },
          onSpringAtRest: function() {
          ...
          var t = void 0,
            n = void 0,
            i = void 0;
          (u !== y || c !== T) && (y = u, T = c, n = _.x + u, i = _.y + c, t = r.rotation(n, i, e, r.maxRotation), r.transform(e, n, i, t), f.trigger("dragmove", {
            target: e,
          ...
          var i = void 0;
          i = r.rotation(t, n, e, r.maxRotation), _.x = t || 0, _.y = n || 0, m.transform(e, t, n, i)
        }, A = function(t, n, i) {
          if (v.fromX = n, v.fromY = i, v.direction = v.fromX < 0 ? m.DIRECTION_LEFT : m.DIRECTION_RIGHT, t === m.THROW_IN) I.setCurrentValue(0).setAtRest().setEndValue(1), f.trigger("throwin", {
            target: e,
            throwDirection: v.direction
          });
          else {
            if (t !== m.THROW_OUT) throw new Error("Invalid throw event.");
            x.setCurrentValue(0).setAtRest().setVelocity(100).setEndValue(1), f.trigger("throwout", {
              target: e,
              throwDirection: v.direction
      ...
      }, o(), n.on = f.on, n.trigger = f.trigger, n.throwIn = function(t, e) {
        A(m.THROW_IN, t, e)
      }, n.throwOut = function(t, e) {
        A(m.THROW_OUT, t, e)
      }, n.destroy = function() {
        S.destroy(), I.destroy(), x.destroy(), t.destroyCard(n)
      }, n
      ...
      var e = void 0,
        n = void 0,
        i = void 0;
      e = t.parentNode, n = d["default"].elementChildren(e), i = n.indexOf(t), i + 1 !== n.length && (e.removeChild(t), e.appendChild(t))
    },
    m.insertBelow = function(t) {
      var e = t.parentNode;
      e.removeChild(t);
      ...
      var r = void 0,
        o = void 0,
        s = void 0;
      return r = Math.min(Math.max(t / n.offsetWidth, -1), 1), s = (e > 0 ? 1 : -1) * Math.min(Math.abs(e) / 100, 1), o = r * s * i
    }, m.DIRECTION_LEFT = -1, m.DIRECTION_RIGHT = 1, m.THROW_IN = "in", m.THROW_OUT = "out", e["default"] = m, t.exports = e["default"]
  }).call(e, function() {
    return this
  }())
}, function(t, e, n) {
  ...
  ! function(r, o, s, u) {
    ...
    function M(t, e) {
      ...
      var o = n.firstInput,
        ...
        a = e.center = j(i);
      e.timeStamp = mt(), e.deltaTime = e.timeStamp - o.timeStamp, e.angle = z(u, a), e.distance = N(u, a), D(n, e), e.offsetDirection = L(e.deltaX, e.deltaY), e.scale = s ? U(s.pointers, i) : 1, e.rotation = s ? W(s.pointers, i) : 0, F(n, e);
      var c = t.element;
    ...
    function F(t, e) {
      ...
      if (e.eventType != Mt && (a > At || s.velocity === u)) {
        var c = s.deltaX - e.deltaX,
          h = s.deltaY - e.deltaY,
          l = P(a, c, h);
        i = l.x, r = l.y, n = gt(l.x) > gt(l.y) ? l.x : l.y, o = L(c, h), t.lastInterval = e
    ...
    function X() {
      this.evEl = qt, this.evWin = Yt, this.allow = !0, this.pressed = !1, R.apply(this, arguments)
    }

    function q() {
      this.evEl = Gt, this.evWin = Bt, R.apply(this, arguments), this.store = this.manager.session.pointerEvents = []
    }

    function Y() {
      this.evTarget = Zt, this.evWin = Jt, this.started = !1, R.apply(this, arguments)
    }

    function k(t, e) {
      var n = w(t.touches),
        i = w(t.changedTouches);
      return e & (Ct | Mt) && (n = I(n.concat(i), "identifier", !0)), [n, i]
    }

    function H() {
      this.evTarget = Qt, this.targetIds = {}, R.apply(this, arguments)
    }

    function G(t, e) {
      var n = w(t.touches),
        i = this.targetIds;
      if (e & (Rt | Ot) && 1 === n.length) return i[n[0].identifier] = !0, [n, n];
      var r, o, s = w(t.changedTouches),
        u = [],
        a = this.target;
      ...
      for (r = 0; r < s.length;) i[s[r].identifier] && u.push(s[r]), e & (Ct | Mt) && delete i[s[r].identifier], r++;
    ...
    function J(t) {
      this.id = b(), this.manager = null, this.options = f(t || {}, this.defaults), this.options.enable = g(this.options.enable, !0), this.state = ae, this.simultaneous = {}, this.requireFail = []
    }
    ...
    function at(t, e) {
      return e = e || {}, e.recognizers = g(e.recognizers, at.defaults.preset), new ct(t, e)
    }

    function ct(t, e) {
      e = e || {}, this.options = f(e, at.defaults), this.options.inputTarget = this.options.inputTarget || t, this.handlers = {}, this.session = {}, this.recognizers = [], this.element = t, this.input = O(this), this.touchAction = new $(this, this.options.touchAction), ht(this, !0), h(e.recognizers, function(t) {
    ...
    p(X, R, {
      handler: function(t) {
        var e = Xt[t.type];
        e & Rt && 0 === t.button && (this.pressed = !0), e & Ot && 1 !== t.which && (e = Ct), this.pressed && this.allow && (e & Ct && (this.pressed = !1), this.callback(this.manager, e, {
          pointers: [t],
          changedPointers: [t],
          pointerType: xt,
          srcEvent: t
    ...
    r.MSPointerEvent && (Gt = "MSPointerDown", Bt = "MSPointerMove MSPointerUp MSPointerCancel"), p(q, R, {
      handler: function(t) {
        var e = this.store,
          n = !1,
        ...
        r & Rt && (0 === t.button || s) ? 0 > u && (e.push(t), u = e.length - 1) : r & (Ct | Mt) && (n = !0), 0 > u || (e[u] = t, this.callback(this.manager, r, {
          pointers: e,
          changedPointers: [t],
          pointerType: o,
          srcEvent: t
    ...
    p(Y, R, {
      handler: function(t) {
        ...
        if (e === Rt && (this.started = !0), this.started) {
          ...
          e & (Ct | Mt) && n[0].length - n[1].length === 0 && (this.started = !1), this.callback(this.manager, e, {
            pointers: n[0],
            changedPointers: n[1],
            pointerType: wt,
            srcEvent: t
    ...
    p(H, R, {
      ...
      handler: function(t, e, n) {
        ...
        e & (Ct | Mt) && (this.mouse.allow = !0), this.callback(t, e, n)
      },
      destroy: function() {
    ...
    J.prototype = {
      ...
      requireFailure: function(t) {
        ...
        return t = tt(t, this), -1 === E(e, t) && (e.push(t), t.requireFailure(this)), this
      },
      ...
      canEmit: function() {
        for (var t = 0; t < this.requireFail.length;) {
          if (!(this.requireFail[t].state & (de | ae))) return !1;
          t++
        }
        return !0
      },
      recognize: function(t) {
        var e = l({}, t);
        return v(this.options.enable, [this, e]) ? (this.state & (fe | pe | de) && (this.state = ae), this.state = this.process(e), void(this.state & (ce | he | le | pe) && this.tryEmit(e))) : (this.reset(), void(this.state = de))
      },
      process: function(t) {},
      ...
      getTouchAction: function() {
        var t = this.options.direction,
          e = [];
        return t & Lt && e.push(ue), t & Nt && e.push(se), e
      },
      directionTest: function(t) {
        var e = this.options,
          ...
          o = t.deltaX,
          s = t.deltaY;
        return r & e.direction || (e.direction & Lt ? (r = 0 === o ? Dt : 0 > o ? Ft : Vt, n = o != this.pX, i = Math.abs(t.deltaX)) : (r = 0 === s ? Dt : 0 > s ? jt : Pt, n = s != this.pY, i = Math.abs(t.deltaY))), t.direction = r, n && i > e.threshold && r & e.direction
      },
      attrTest: function(t) {
      ...
      process: function(t) {
        ...
        if (this._input = t, !i || !n || t.eventType & (Ct | Mt) && !r) this.reset();
        else if (t.eventType & Rt) this.reset(), this._timer = a(function() {
          this.state = fe, this.tryEmit()
        }, e.time, this);
        else if (t.eventType & Ct) return fe;
        return de
      },
      reset: function() {
      ...
      emit: function(t) {
        this.state === fe && (t && t.eventType & Ct ? this.manager.emit(this.options.event + "up", t) : (this._input.timeStamp = mt(), this.manager.emit(this.options.event, this._input)))
      }
    }), p(ot, et, {
      defaults: {
        event: "rotate",
      ...
      attrTest: function(t) {
        ...
        return n & (Lt | Nt) ? e = t.velocity : n & Lt ? e = t.velocityX : n & Nt && (e = t.velocityY), this._super.attrTest.call(this, t) && n & t.direction && t.distance > this.options.threshold && gt(e) > this.options.velocity && t.eventType & Ct
      },
      emit: function(t) {
        var e = Q(t.direction);
      ...
      process: function(t) {
        ...
        if (i && r && n) {
          ...
          if (0 === u) return this.hasRequireFailures() ? (this._timer = a(function() {
            this.state = fe, this.tryEmit()
    ...
    ct.prototype = {
      ...
      recognize: function(t) {
        ...
        if (!e.stopped) {
          ...
          for (var o = 0; o < i.length;) n = i[o], e.stopped === ge || r && n != r && !n.canRecognizeWith(r) ? n.reset() : n.recognize(t), !r && n.state & (ce | he | le) && (r = e.curRecognizer = n), o++
        }
      },
      get: function(t) {
      ...
      return at
    }.call(e, n, e, t), !(i !== u && (t.exports = i))) : "undefined" != typeof t && t.exports ? t.exports = at : r[s] = at
  ...
  function i(t) {
    ...
    for (n = r(t); i--;)
      if (e = u[i] + n, void 0 !== s[e]) return e;
  ...
  function o(t) {
    var e = n(t),
      i = /([A-Z])/g;
    return i.test(e) && (e = (a.test(e) ? "-" : "") + e.replace(i, "-$1")), e.toLowerCase()
  }
  var s = document.createElement("p").style,
    u = "O ms Moz webkit".split(" "),
    a = /^(o|ms|moz|webkit)/,
    c = {};
  t.exports = n, t.exports.dash = o
}, function(t, e, n) {
  "use strict";
  ...
  var r = n(11),
    ...
    p = i(f),
    d = void 0;
  d = {}, d.remove = o["default"], d.assign = u["default"], d.random = c["default"], d.find = l["default"], d.where = p["default"], d.elementChildren = function(t) {
  ...
  function i(t, e, n) {
    ...
    for (; ++i < s;) {
      ...
      if (u && a[2]) {
        ...
        if (!(void 0 === f ? r(l, h, n, !0) : f)) return !1
      }
    }
    return !0
  }
  ...
  function i(t, e, n, i, f, v, g) {
    var m = u(t),
      ...
      y = h,
      T = h;
    m || (y = d.call(t), y == c ? y = l : y != l && (m = a(t))), _ || (T = d.call(e), T == c ? T = l : T != l && (_ = a(e)));
    var S = y == l,
      E = T == l,
      w = y == T;
    if (w && !m && !S) return o(t, e, y);
    if (!f) {
      var I = S && p.call(t, "__wrapped__"),
        x = E && p.call(e, "__wrapped__");
      if (I || x) return n(I ? t.value() : t, x ? e.value() : e, i, f, v, g)
    }
    if (!w) return !1;
    v || (v = []), g || (g = []);
    for (var b = v.length; b--;)
      if (v[b] == t) return g[b] == e;
    v.push(t), g.push(e);
    var A = (m ? r : s)(t, e, n, i, f, v, g);
    return v.pop(), g.pop(), A
  }
  var r = n(17),
    o = n(19),
    s = n(20),
  ...
  function i(t, e, n, i, o, s, u) {
    ...
    for (; ++a < c;) {
      ...
      } else if (l !== f && !n(l, f, i, o, s, u)) return !1
    }
    return !0
  }
  var r = n(18);
  ...
  function i(t, e, n, i, o, u, a) {
    ...
    for (var v = o; ++p < h;) {
      ...
      if (!(void 0 === _ ? n(g, m, i, o, u, a) : _)) return !1;
      v || (v = "constructor" == d)
    }
    if (!v) {
      var y = t.constructor,
        T = e.constructor;
      if (y != T && "constructor" in t && "constructor" in e && !("function" == typeof y && y instanceof y && "function" == typeof T && T instanceof T)) return !1
    }
    return !0
  }
  var r = n(21),
  ...
  function i(t) {
    ...
    var e = t.length;
    e = e && u(e) && (o(t) || r(t)) && e || 0;
    for (var n = t.constructor, i = -1, c = "function" == typeof n && n.prototype === t, l = Array(e), f = e > 0; ++i < e;) l[i] = i + "";
    for (var p in t) f && s(p, e) || "constructor" == p && (c || !h.call(t, p)) || l.push(p);
    return l
  }
  var r = n(32),
    o = n(33),
  ...
  var r = n(30),
    ...
    O = {};
  O[T] = O[S] = O[E] = O[w] = O[I] = O[x] = O[b] = O[A] = O[R] = !0, O[s] = O[u] = O[y] = O[a] = O[c] = O[h] = O[l] = O[f] = O[p] = O[d] = O[v] = O[g] = O[m] = O[_] = !1;
  ...
  function i(t, e) {
    ...
    return t = f(t),
      function(u) {
        ...
        var a = p;
        if (u = l(u), (n || !i) && !(a in u)) {
          if (u = 1 == t.length ? u : r(u, s(t, 0, -1)), null == u) return !1;
          a = h(t), u = l(u)
        }
  ...
  function i(t, e) {
    var n = typeof t;
    if ("string" == n && u.test(t) || "number" == n) return !0;
    if (r(t)) return !1;
    var i = !s.test(t);
  ...
  function i(t) {
    return s(function(e, n) {
      var i = -1,
        ...
        a = s > 2 ? n[2] : void 0,
        c = s > 1 ? n[s - 1] : void 0;
      for ("function" == typeof u ? (u = r(u, c, 5), s -= 2) : (u = "function" == typeof c ? c : void 0, s -= u ? 1 : 0), a && o(n[0], n[1], a) && (u = 3 > s ? void 0 : u, s = 1); ++i < s;) {
        var h = n[i];
        h && t(e, h, u)
      }
      return e
  ...
  function i(t, e, n) {
    ...
    var i = null == t,
      a = null == e;
    if (null == n && (a && "boolean" == typeof t ? (n = t, t = 1) : "boolean" == typeof e && (n = e, a = !0)), i && a && (e = 1, a = !1), t = +t || 0, a ? (e = t, t = 0) : e = +e || 0, n || t % 1 || e % 1) {
      var c = u();
  ...
  for (var i = n(76), r = "undefined" == typeof window ? {} : window, o = ["moz", "webkit"], s = "AnimationFrame", u = r["request" + s], a = r["cancel" + s] || r["cancelRequest" + s], c = 0; c < o.length && !u; c++) u = r[o[c] + "Request" + s],
